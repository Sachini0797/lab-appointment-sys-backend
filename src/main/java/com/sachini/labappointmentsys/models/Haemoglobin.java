...
public class Haemoglobin {
    ...
    public Haemoglobin(Long uid, Long appointmentId, Boolean completed, LocalDateTime createdDate, LocalDateTime sampleCollectedDate, LocalDateTime sampleReceivedDate, LocalDateTime reportAuthorizedDate, String haemoglobin, String refNo, String refBy, String remarks) {
        this.uid = uid;
